! A.4.1 P148 The LBM Code for a heated lid-driven cavity
program LBM_heated_lid_driven
...
integer i
open(2,file='lbm_heated_lid-driven-uvfield.result')
open(3,file='lbm_heated_lid-driven-uvely.result')
open(4,file='lbm_heated_lid-driven-vvelx.result')
!
...
stop
end program LBM_heated_lid_driven
...
open(5, file='lbm_heated_lid-driven-streamf.result')
open(7, file='lbm_heated_lid-driven-tprof.result')
