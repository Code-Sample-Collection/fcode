! A.4.2 P157 The LBM Code for a forced convection
program LBM_forced_convection
...
integer i
open(2,file='lbm_forced-uvfield.result')
open(3,file='lbm_forced-uvely.result')
open(4,file='lbm_forced-vvelx.result')
!
...
stop
end program LBM_forced_convection
